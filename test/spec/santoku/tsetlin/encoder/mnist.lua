...
local cfg; cfg = {
  ...
  search = {
    ...
    adjacency = {
      spectral = {
        knn = { def = 27, min = 16, max = 32, int = true },
        knn_alpha = { def = 28, min = 12, max = 32, int = true },
        weight_decay = { def = 4.62, min = 2, max = 16 },
...
test("mnist-raw", function()
  ...
  train.embedding_params = best_params
  train.retrieval_stats = best_metrics
  ...
  local base_retrieval = eval.ranking_accuracy({
